          ...
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                key={category.id}
                className={`group ${
                  filter === category.urlParamName ? "bg-textColor" : "bg-card"
                } w-24 min-w-[94px] h-28 cursor-pointer rounded-lg drop-shadow-xl flex flex-col gap-3 items-center justify-center hover:bg-textColor `}
