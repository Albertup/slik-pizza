      ...
      <div className='w-[90%] lg:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className="w-full">
          <select
            ...
            <option value="other" className="bg-white">{t('CategoryUp')}</option>
            {
              categories && categories.map((item) => (
                <option
                  key={item.id} className="text-base border-0 outline-none capitalize bg-white text-headingColor" value={item.urlParamName}>
                  {item.name}
                </option>
            ))}
          </select>
                ...
                <>
                  <label className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                    <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                      ...
                      <p className="text-gray-500 hover:text-gray-700">{t('UploadUp')}</p>
                    </div>
